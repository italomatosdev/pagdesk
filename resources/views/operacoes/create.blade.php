        ...
        <div class="row">
            <div class="col-lg-8 mx-auto">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('operacoes.store') }}" method="POST" class="form-criar-operacao" data-no-loading>
                            @csrf
                            ...
                            <div class="mb-3">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="permite_emprestimo_retroativo" id="permite_emprestimo_retroativo"
                                           value="1" {{ old('permite_emprestimo_retroativo', false) ? 'checked' : '' }}>
                                    <label class="form-check-label" for="permite_emprestimo_retroativo">
                                        <strong>Permitir empréstimo retroativo</strong>
                                    </label>
                                </div>
                                <small class="text-muted">
                                    Se marcado, gestores e administradores poderão cadastrar empréstimos já existentes (data no passado) e vincular a um consultor.
                                </small>
                            ...
                            <div class="d-flex justify-content-end gap-2">
                                <a href="{{ route('operacoes.index') }}" class="btn btn-secondary">
