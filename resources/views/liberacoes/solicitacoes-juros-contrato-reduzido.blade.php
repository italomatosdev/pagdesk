...
@section('title')
    Solicitações – Valor Inferior (Juros do Contrato Reduzido)
@endsection
@section('page-title')
    Solicitações – Valor Inferior (Juros do Contrato Reduzido)
@endsection
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                            <h4 class="card-title mb-0">Pagamentos com valor inferior ao devido – aguardando aprovação</h4>
                    ...
                    <div class="card-body">
                        ...
                        <p class="text-muted mb-3">
                            O consultor solicitou registrar um pagamento com <strong>valor inferior</strong> ao da parcela (juros do contrato reduzido). O valor nunca é menor que o principal. Revise e <strong>aprove</strong> ou <strong>rejeite</strong>.
                        </p>

                        <form method="GET" action="{{ route('liberacoes.juros-contrato-reduzido') }}" class="mb-3">
                            <div class="row g-3">
                                <div class="col-md-4">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped mb-0">
                                ...
                                <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex gap-1 flex-wrap">
                                                    <form action="{{ route('liberacoes.juros-contrato-reduzido.aprovar', $s->id) }}" method="post" class="d-inline" onsubmit="return confirm('Aprovar? O pagamento será registrado na parcela com o valor solicitado.');">
                                                        @csrf
                                                        <button type="submit" class="btn btn-sm btn-success" title="Aprovar"><i class="bx bx-check"></i> Aprovar</button>
                                                    </form>
                                                    <form action="{{ route('liberacoes.juros-contrato-reduzido.rejeitar', $s->id) }}" method="post" class="d-inline" onsubmit="return confirm('Rejeitar? O consultor poderá registrar um novo pagamento.');">
                                                        @csrf
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="12" class="text-center">Nenhuma solicitação aguardando aprovação.</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
