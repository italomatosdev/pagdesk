            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Cadastrar Nova Empresa</h4>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('super-admin.empresas.store') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="cnpj" class="form-control @error('cnpj') is-invalid @enderror" 
                                           value="{{ old('cnpj') }}" placeholder="00000000000000">
                                    @error('cnpj')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" name="permite_multiplas_operacoes" id="permite_multiplas_operacoes" 
                                               value="1" {{ old('permite_multiplas_operacoes', true) ? 'checked' : '' }}>
                            ...
                            <div class="d-flex justify-content-end gap-2">
                                <a href="{{ route('super-admin.empresas.index') }}" class="btn btn-secondary">
