                    ...
                    <div class="card-body">
                        @if($operacao->empresa)
                            <div class="alert alert-info mb-3">
                                ...
                                <strong>Empresa:</strong> {{ $operacao->empresa->nome }}
                            </div>
                        @endif

                        <form action="{{ route('super-admin.operacoes.update', $operacao->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                                ...
                                <select name="empresa_id" class="form-select" required>
                                    ...
                                    @foreach($empresas as $empresa)
                                        <option value="{{ $empresa->id }}" 
                                                {{ old('empresa_id', $operacao->empresa_id) == $empresa->id ? 'selected' : '' }}>
                                            {{ $empresa->nome }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <small class="text-muted">Por operação: consultores registram vendas e veem catálogo sem editar produtos.</small>
                            ...
                            <div class="mb-3">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="ativo" 
                                           id="ativo" value="1" 
                                           {{ old('ativo', $operacao->ativo ?? true) ? 'checked' : '' }}>
                            ...
                            <div class="d-flex justify-content-end gap-2">
                                <a href="{{ route('super-admin.operacoes.show', $operacao->id) }}" class="btn btn-secondary">
