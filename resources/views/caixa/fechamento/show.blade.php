...
@section('title')
    Fechamento de Caixa #{{ $settlement->id }}
@endsection
@section('page-title')
    Fechamento de Caixa #{{ $settlement->id }}
@endsection
                    ...
                    <div class="card-header bg-primary text-white">
                        <div class="d-flex align-items-center justify-content-between">
                            <h4 class="card-title mb-0 text-white">
                                <i class="bx bx-lock-alt me-2"></i>Fechamento de Caixa #{{ $settlement->id }}
                            </h4>
                            <div>
                                @php
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                @include('partials.comprovante-extras', [
                                    ...
                                    'modalSuffix' => 'Fech'.$settlement->id,
                                ])
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                            <a href="{{ route('fechamento-caixa.index') }}" class="btn btn-secondary">
        ...
        <div class="modal fade" id="comprovanteModal" tabindex="-1" aria-labelledby="comprovanteModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form id="formComprovante" method="POST" action="{{ route('fechamento-caixa.anexar-comprovante', $settlement->id) }}" enctype="multipart/form-data">
                        @csrf
                        <div class="modal-body">
                            <div class="mb-3">
